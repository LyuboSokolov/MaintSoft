...
namespace MaintSoft.Infrastructure.Migrations
{
    ...
    [Migration("20221128201235_AddSomeEntityesForCreatedAndDeleteUser")]
    partial class AddSomeEntityesForCreatedAndDeleteUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MaintSoft.Infrastructure.Data.ApplicationUserTask", b =>
                {
                    ...
                    b.ToTable("ApplicationUsersTasks");
                });
            ...
            modelBuilder.Entity("MaintSoft.Infrastructure.Data.MachineTask", b =>
                {
            ...
            modelBuilder.Entity("MaintSoft.Infrastructure.Data.Task", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MaintSoft.Infrastructure.Data.ApplicationUserTask", b =>
                {
                    ...
                    b.HasOne("MaintSoft.Infrastructure.Data.Task", "Task")
                        .WithMany("ApplicationUserTasks")
